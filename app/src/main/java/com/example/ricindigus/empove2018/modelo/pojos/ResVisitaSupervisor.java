...
public class ResVisitaSupervisor {
    ...
    public ContentValues toValues(){
        ...
        contentValues.put(SQLConstantes.resultado_supervisor_vis_fecha_final_mm ,vis_fecha_final_mm);
        contentValues.put(SQLConstantes.resultado_supervisor_vis_fecha_final_aa ,vis_fecha_final_aa);
