                ...
                btnFinalizarVisita.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(valido){
                            ...
                            ContentValues contentValues = new ContentValues();
                            contentValues.put(SQLConstantes.visita_supervisor_vis_resu,String.valueOf(spResultado.getSelectedItemPosition()));
...
//    }
    ...
    public void cargarDatos(){
        ...
        dataTablas.open();
        if(dataTablas.existeElemento(getIdTablaParte2(), idHogar)){
            txtResultadoFinal.setText(getResources().getStringArray(R.array.visita_array_resultados)[Integer.parseInt(dataTablas.getValor(getIdTablaParte2(),SQLConstantes.resultado_supervisor_vis_resultado_final, idHogar))]);
