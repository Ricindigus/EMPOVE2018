...
public class FragmentP701P705 extends FragmentPagina {
    ...
    private int c7_p701;
    private int c7_p702_1;
    private int c7_p702_2;
    private int c7_p702_3;
    private int c7_p702_4;
    private int c7_p702_5;
    private int c7_p702_6;
    private int c7_p702_7;
    private int c7_p702_8;
    private int c7_p702_9;
    private int c7_p702_10;
    private String c7_p702_o;
    private int c7_p703;
    private int c7_p704_1;
    private int c7_p704_2;
    private int c7_p704_3;
    private int c7_p704_4;
    private int c7_p704_5;
    private int c7_p704_6;
    private String c7_p704_o;
    private int c7_p705_1;
    private int c7_p705_2;
    private int c7_p705_3;
    private int c7_p705_4;
    private int c7_p705_5;
    private int c7_p705_6;
    private int c7_p705_7;
    ...
    public void cargarDatos() {
        ...
        if(data.existeElemento(getNombreTabla(), idEncuestado)){
            ...
            if(modulo7.getC7_p702_1().equals("1")) c7_p702_1_Checkbox.setChecked(true);if(modulo7.getC7_p702_1().equals("0")) c7_p702_1_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_2().equals("1")) c7_p702_2_Checkbox.setChecked(true);if(modulo7.getC7_p702_2().equals("0")) c7_p702_2_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_3().equals("1")) c7_p702_3_Checkbox.setChecked(true);if(modulo7.getC7_p702_3().equals("0")) c7_p702_3_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_4().equals("1")) c7_p702_4_Checkbox.setChecked(true);if(modulo7.getC7_p702_4().equals("0")) c7_p702_4_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_5().equals("1")) c7_p702_5_Checkbox.setChecked(true);if(modulo7.getC7_p702_5().equals("0")) c7_p702_5_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_6().equals("1")) c7_p702_6_Checkbox.setChecked(true);if(modulo7.getC7_p702_6().equals("0")) c7_p702_6_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_7().equals("1")) c7_p702_7_Checkbox.setChecked(true);if(modulo7.getC7_p702_7().equals("0")) c7_p702_7_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_8().equals("1")) c7_p702_8_Checkbox.setChecked(true);if(modulo7.getC7_p702_8().equals("0")) c7_p702_8_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_9().equals("1")) c7_p702_9_Checkbox.setChecked(true);if(modulo7.getC7_p702_9().equals("0")) c7_p702_9_Checkbox.setChecked(false);
            if(modulo7.getC7_p702_10().equals("1")) c7_p702_10_Checkbox.setChecked(true);if(modulo7.getC7_p702_10().equals("0")) c7_p702_10_Checkbox.setChecked(false);
            ...
            if(modulo7.getC7_p704_1().equals("1")) c7_p704_1_Checkbox.setChecked(true);if(modulo7.getC7_p704_1().equals("0")) c7_p704_1_Checkbox.setChecked(false);
            if(modulo7.getC7_p704_2().equals("1")) c7_p704_2_Checkbox.setChecked(true);if(modulo7.getC7_p704_2().equals("0")) c7_p704_2_Checkbox.setChecked(false);
            if(modulo7.getC7_p704_3().equals("1")) c7_p704_3_Checkbox.setChecked(true);if(modulo7.getC7_p704_3().equals("0")) c7_p704_3_Checkbox.setChecked(false);
            if(modulo7.getC7_p704_4().equals("1")) c7_p704_4_Checkbox.setChecked(true);if(modulo7.getC7_p704_4().equals("0")) c7_p704_4_Checkbox.setChecked(false);
            if(modulo7.getC7_p704_5().equals("1")) c7_p704_5_Checkbox.setChecked(true);if(modulo7.getC7_p704_5().equals("0")) c7_p704_5_Checkbox.setChecked(false);
            if(modulo7.getC7_p704_6().equals("1")) c7_p704_6_Checkbox.setChecked(true);if(modulo7.getC7_p704_6().equals("0")) c7_p704_6_Checkbox.setChecked(false);
            c7_p704_o_EditText.setText(modulo7.getC7_p704_o());
            if(modulo7.getC7_p705_1().equals("1")) c7_p705_1_Checkbox.setChecked(true);if(modulo7.getC7_p705_1().equals("0")) c7_p705_1_Checkbox.setChecked(false);
            if(modulo7.getC7_p705_2().equals("1")) c7_p705_2_Checkbox.setChecked(true);if(modulo7.getC7_p705_2().equals("0")) c7_p705_2_Checkbox.setChecked(false);
            if(modulo7.getC7_p705_3().equals("1")) c7_p705_3_Checkbox.setChecked(true);if(modulo7.getC7_p705_3().equals("0")) c7_p705_3_Checkbox.setChecked(false);
            if(modulo7.getC7_p705_4().equals("1")) c7_p705_4_Checkbox.setChecked(true);if(modulo7.getC7_p705_4().equals("0")) c7_p705_4_Checkbox.setChecked(false);
            if(modulo7.getC7_p705_5().equals("1")) c7_p705_5_Checkbox.setChecked(true);if(modulo7.getC7_p705_5().equals("0")) c7_p705_5_Checkbox.setChecked(false);
            if(modulo7.getC7_p705_6().equals("1")) c7_p705_6_Checkbox.setChecked(true);if(modulo7.getC7_p705_6().equals("0")) c7_p705_6_Checkbox.setChecked(false);
            if(modulo7.getC7_p705_7().equals("1")) c7_p705_7_Checkbox.setChecked(true);if(modulo7.getC7_p705_7().equals("0")) c7_p705_7_Checkbox.setChecked(false);
    ...
    public boolean validarDatos(){
        ...
        if (c7_p701 == -1){mostrarMensaje("PREGUNTA 701: DEBE MARCAR UNA OPCIÓN"); return false;}
        ...
        if (m7_p705_linearlayout.getVisibility() == View.VISIBLE){
            if (c7_p705_1 == 0 && c7_p705_2 == 0 && c7_p705_3 == 0 && c7_p705_4 == 0 && c7_p705_5 == 0 && c7_p705_6 == 0 && c7_p705_7 == 0){
